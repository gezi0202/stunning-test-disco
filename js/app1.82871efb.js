...
/*!****************************!*\
  ...
  \****************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _index_index_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../index/index.scss */ "./src/index/index.scss");
...
function _render() {
  _render = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(page, address) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return axios__WEBPACK_IMPORTED_MODULE_2__["default"].get(address);
        case 2:
          res = _context.sent;
          console.log(res.data.items);
          page.innerHTML = res.data.items.map(function (item, i) {
            return "\n            <dl dataIndex = \"".concat(i, "\">\n                <dt><img src=\"").concat(item.img, "\" alt=\"\"></dt>\n                <dd>\n                <p>").concat(item.title, "</p>\n                <p>\u6708\u9500").concat(item.sold, "\u7B14</p>\n                <p>\uFFE5").concat(item.price, "</p>\n                </dd>\n            </dl>\n        ");
          }).join("");
        case 5:
        case "end":
...
el(".sold").addEventListener("click", function () {
  el(".active").classList.remove("active");
...
/******/ })()
;
//# sourceMappingURL=app1.82871efb.js.map